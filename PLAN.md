...
- [ ] Реализовать минимальный HTTP сервер в `main.go`
- [ ] Настроить маршрутизацию только требуемых эндпоинтов
- [ ] Настроить сервер на прослушивание 0.0.0.0:8000
- [ ] Исключить логирование, статическую раздачу файлов и graceful shutdown
