...
This file defines the persistent state, personality, and rules for the Antigravity AI assistant working on the **RipX Reborn** project.

## 🧠 Project Context
*   **Name:** RipX Reborn
*   **Nature:** Lightweight, fast, and visually stunning image hosting/album service.
...
3.  **Tagging:** Use Semantic Versioning (e.g., `v2.2.0`).
...
*   Maintain the "RipX" vibe: "живой, даже когда лежит" (alive even when down).